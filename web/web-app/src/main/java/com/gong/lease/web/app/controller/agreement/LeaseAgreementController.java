package com.gong.lease.web.app.controller.agreement;
...
import com.gong.lease.model.enums.LeaseStatus;
import com.gong.lease.web.app.service.LeaseAgreementService;
...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        List<AgreementItemVo> result = service.listItem(LoginUserHolder.getLoginUser().getUsername());
